...
$active_content = ""; //Portfolio page [help]: The name of the page where you want menues for content to be available, other pages won't show the list of tags or entries.
$loadingImg = "core/themes/simple2/gfx/ajax-loader.gif"; //Loading image [help]: Relative path to an image to use as loader when loading new content.
