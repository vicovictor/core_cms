...
<div id="header">
<p id="logo"><img src="http://core.weareastronauts.org/core_logo_small_black.png" /></p>
        <div class="menu-obj" onclick="get_data('show_statistics')">OVERVIEW</div>
        <div class="menu-obj" onclick="get_data('show_config')">CONFIGURATION</div>
        <div class="menu-obj" onclick="get_data('show_entries')">CONTENT</div>
        <div class="menu-obj" onclick="get_data('show_tags')">TAGS</div>
        <div class="menu-obj" onclick="get_data('show_themes')">STYLE/LAYOUT</div>
        <div class="menu-obj" onclick="get_data('show_info')">INFO/FAQ</div>
        <div class="menu-obj"><a href="functions/logout.php">&mdash;Logout</a></div>
</div>
